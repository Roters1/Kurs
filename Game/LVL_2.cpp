...
{
	if(Shape3->Left <= ((TShape*)FindComponent(Sname))->Left+10 ){
...
{
	if(Shape3->Top <= ((TShape*)FindComponent(Sname))->Top+10 ){
	((TShape*)FindComponent(Sname))->Brush->Color = 	Shape3->Brush->Color ;
	}
...
{
	if(Shape3->Left <= Shape11->Left+10 ){
...
{
	if(Shape3->Left <= Shape10->Left+10 ){
...
if   (Shape4->Brush->Color == clLime && Shape5->Brush->Color == clLime && Shape6->Brush->Color == clLime && Shape7->Brush->Color == clLime && Shape8->Brush->Color == clLime && Shape9->Brush->Color == clLime && Shape10->Brush->Color == clLime && Shape11->Brush->Color == clLime  )
{
Label1->Visible = true;

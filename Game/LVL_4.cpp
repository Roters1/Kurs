...
//5
   for(int i = 5;i < 14 ; i++ )   {
	...
	if(	i !=12  && i !=10 ){
		...
		else if(Shape2->Top <= ((TShape*)FindComponent(Sname))->Top+10 && Shape2->Top >= ((TShape*)FindComponent(Sname))->Top-10  )
		{
	...
	else if (Shape4->Left <= ((TShape*)FindComponent(Sname))->Left+10 && Shape4->Left >= ((TShape*)FindComponent(Sname))->Left-10  )
	{
		if(Shape4->Top <= ((TShape*)FindComponent(Sname))->Top+10 ){
		((TShape*)FindComponent(Sname))->Brush->Color = 	Shape4->Brush->Color ;
		}
		else{
	   ((TShape*)FindComponent(Sname))->Brush->Color =  clWhite;
	}
